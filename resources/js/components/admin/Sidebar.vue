  ...
  >
    ...
    <nav class="flex-1 min-h-0 overflow-y-auto overflow-x-hidden space-y-1 p-4">
      ...
      >
        ...
        <span v-if="!isCollapsed">Invite-коды</span>
      </router-link>
      <router-link
        to="/admin/users"
        class="flex items-center rounded-xl text-sm font-medium transition-all px-4 py-3 gap-3"
      ...
      <router-link
        to="/admin/lexauto/orders"
        class="flex items-center rounded-xl text-sm font-medium transition-all px-4 py-3 gap-3"
        :class="[
          isCollapsed ? 'justify-center' : '',
          route.name === 'admin.lexauto.orders'
            ? 'bg-gray-800 text-white'
            : 'text-gray-300 hover:bg-gray-800 hover:text-white'
        ]"
        @click="handleMobileMenuClick"
      >
        ...
        <span v-if="!isCollapsed">LEXAUTO</span>
      </router-link>
      <router-link
